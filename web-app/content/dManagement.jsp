      ...
      <div class="row" style="margin: 0px 15px;">
        <div class="col-md-6" id="">
				...
				<div class="col-md-5 hidden-sm hidden-xs">
		          <img class="img-circle img-responsive" src="/images/abc.jpeg" alt="" >
		        </div>
		        <div class="col-md-7">
        ...
        <div class="col-md-6" id="">
          		<div class="row featurette">
				<div class="col-md-5 hidden-sm hidden-xs">
		          <img class="img-circle img-responsive" src="/images/capacity.jpeg" alt="">
		        </div>
		        <div class="col-md-7">
...
<div id="contentBody">
	<div class="row" style="margin: 0px 15px;">
	    ...
	    <div class="col-md-6" id="">
	    	<div class="row featurette">
			<div class="col-md-5 hidden-sm hidden-xs">
	          <img class="img-circle img-responsive" src="/images/building.jpeg" alt="">
	        </div>
	        <div class="col-md-7">
